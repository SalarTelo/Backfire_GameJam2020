...
namespace SpellcastStudios
{
    ...
    public class MonoBehaviourSingleton<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        /// </summary>
        [ClearOnReload] protected static T _instance;
        ...
        void Awake()
        {
            ...
            //Found Duplicate
            if (_instance != null && thisInstance != _instance)
            {
