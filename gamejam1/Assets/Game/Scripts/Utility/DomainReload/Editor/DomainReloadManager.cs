...
namespace ArdenfallEditor
{
    /// <summary>
    /// System that allows for easy clearing of values and triggering of functions to make domain reloading work
    /// </summary>
    public class DomainReloadHandler
    {
        ...
        /// <summary>
        /// Simple helper function that returns members of all types that have a certain attribute
        /// </summary>
